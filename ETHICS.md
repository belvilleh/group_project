...
## A. Data Collection
 ...
 - [NA] **A.4 Downstream bias mitigation**: Have we considered ways to enable testing downstream results for biased outcomes (e.g., collecting data on protected group status like race or gender)?
...
## C. Analysis
 - [X] **C.6 Well-Posed Problem**: Is it possible to answer the question with data? Is the problem well-posed?
